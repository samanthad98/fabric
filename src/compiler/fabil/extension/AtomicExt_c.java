...
public class AtomicExt_c extends FabILExt_c {
  ...
  public Node rewriteAtomic(AtomicRewriter ar) {
    ...
    String block = "{\n" + "  %LS\n"
        ...
        + "  int " + backoff + " = 1;\n"
        + "  java.util.List " + casecode + " = new java.util.ArrayList();\n"
        ...
        + "      switch (" + doBackoff + ") {\n"
        + "        case Pause:\n"
        + "          " + tm + ".stats.addRetrycase(" +casecode + ");\n"
        + "          break;\n"
        + "        case BOnon:\n"
        ...
        + "        fabric.common.Logging.WORKER_TRANSACTION_LOGGER.log(java.util.logging.Level.INFO, " + tm + ".stats.casestring());\n"
        + "        " + tm + ".stats.reset();\n"
        + "      }\n"
        + "    }\n"
        + "  }\n"
