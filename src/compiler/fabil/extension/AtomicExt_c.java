...
public class AtomicExt_c extends FabILExt_c {
  ...
  public Node rewriteAtomic(AtomicRewriter ar) {
    ...
    String block = "{\n" + "  %LS\n"
        ...
        + "  int " + backoff + " = 1;\n"
        + "  boolean " + doBackoff + " = fabric.common.util.BackoffWrapper.BackoffCase.BO;\n"
        ...
        + "                fabric.common.Logging.WORKER_TRANSACTION_LOGGER.log(java.util.logging.Level.INFO, slept for " + t + ");\n"
        + "                break;\n"
