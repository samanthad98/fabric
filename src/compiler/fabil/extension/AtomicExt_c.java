...
public class AtomicExt_c extends FabILExt_c {
  ...
  public Node rewriteAtomic(AtomicRewriter ar) {
    ...
    String block = "{\n" + "  %LS\n"
        ...
        + "  int " + backoff + " = 1;\n"
        + "  List<fabric.common.util.CaseCode> " + casecode + " = new java.util.ArrayList<>();\n"
        ...
        + "        case Pause:\n"
        + "          String casestring = \"0\";\n"
        + "          fabric.common.Logging.WORKER_TRANSACTION_LOGGER.log(java.util.logging.Level.INFO, \"Backoff.Pause becasue \" + casestring);\n"
        + "          break;\n"
        + "        case BOnon:\n"
        + "          " + tm + ".stats.addBackoffCount();\n"
        + "          String casestring = \"0\";\n"
        + "          fabric.common.Logging.WORKER_TRANSACTION_LOGGER.log(java.util.logging.Level.INFO, \"Backoff.BOnon becasue \" + casestring);\n"
        + "          if (" + backoff + " > 32) {\n"
        + "            while (true) {\n"
        + "              try {\n"
        ...
        + "          " + tm + ".stats.addBackoffCount();\n"
        + "          String casestring = \"0\";\n"
        + "          fabric.common.Logging.WORKER_TRANSACTION_LOGGER.log(java.util.logging.Level.INFO, \"Backoff.BO becasue \" + casestring);\n"
        + "          if (" + backoff + " > 32) {\n"
        + "            while (true) {\n"
        + "              try {\n"
        + "                long " + t + " = java.lang.Math.round(java.lang.Math.random() * " + backoff + ");\n"
